...
/**
 * The entity class for the single linked list is represented as a SQLite table
 * aka the table that will hold the list values.
 * Each property in this class represents a column in the table.
 */
@Entity(tableName = "single_list_table")
public class SingleLinkedListRoom {
     ...
     */
    public SingleLinkedListRoom(int val){
        this.val = val;
    }
     ...
     */
    public SingleLinkedListRoom(int val, int pos){
        this.val = val;
        this.position = pos;
    }
